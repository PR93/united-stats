...
const Hero = () => {
  ...
  <div className='bg-white h-screen flex flex-col justify-center items-center text-united-red2'>
    <h1 className='lg:text-9xl md:text-7xl sm:text-5xl text-3xl mb-10'>
      ...
      <Link to='/menu' className=' py-6 px-10 bg-united-graphite rounded-full text-united-red2 text-3xl hover:bg-united-red2 hover:text-united-graphite transition duration-300 flex items-center hover:animate-bounce'>
